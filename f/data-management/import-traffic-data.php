	...
	<body>
		...
		<div class="container">
			...
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="f/data-management/import-traffic-data.php">话务数据导入</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul>
						...
						<li>可以选择csv文件或xls文件</li>
						<li>推荐使用csv文件（速度更快）</li>
					</ul>
				</div>
			</div>
		</div>
...
$(document).ready(function(){
 ...
 // 清除已经上传得到文件
	...
	$('#import').click(function() {
		...
		var dest = "Action/09ImportTRAFFIC.php";
		$.getJSON(
		dest,
		{fname:fname}, 
		function (data){
